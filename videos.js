...
function heartVideo(divElmt) {
  let heartButtons = document.querySelectorAll("div.heart");
  heartButtons.forEach(x => {
    x.classList.remove("unloved");
    x.classList.add("unloved");
  })
  divElmt.classList.toggle("unloved");
}
